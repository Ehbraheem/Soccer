...
export default class Player extends Component {
	...
	render() {
		...
		const offense = player.kickingAbilities + player.passingAbilities + player.ballManipulation + player.gameStrategy + player.fieldCoverage + player.playmakingRisks
		const total   = player.kickingAbilities + player.passingAbilities + player.ballManipulation + player.gameStrategy + player.fieldCoverage + player.playmakingRisks + player.duelTackling + player.blockingAbilities
